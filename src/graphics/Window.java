...
public class Window {
     ...
     * {@link Window#Window(String, Vec2, Vec2)} for details on reference resolution.
     */
     ...
     */
    public Window(String title, Vec2 minWindowSize) {
     ...
     *                                  {@link Window#canvas} is measured in pixels. Otherwise, length is
     ...
     */
    public Window(String title, Vec2 minWindowSize, Vec2 referenceWindowResolution) {
        canvas = new Canvas(new Vec2i(referenceWindowResolution));
     ...
     * {@link Window}, in order to ensure it affects the
