...
public record JGraphics(Graphics2D originalGraphics, Vec2 targetSize) {
    ...
    public JGraphics drawLine(double x, double y, double x1, double y1) {
        originalGraphics.draw(new Line2D.Double(x, y, x1, y1));
        return this;
    }

    public JGraphics drawOval(double x, double y, double width, double height) {
        originalGraphics.draw(new Arc2D.Double(x, y, width, height, 0, 360, Arc2D.OPEN));
        return this;
    }

    public JGraphics fillOval(double x, double y, double width, double height) {
        originalGraphics.fill(new Arc2D.Double(x, y, width, height, 0, 360, Arc2D.OPEN));
        return this;
    }
